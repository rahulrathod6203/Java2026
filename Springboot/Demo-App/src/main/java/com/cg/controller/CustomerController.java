...
public class CustomerController {
	...
	@GetMapping("/home")
	public String welcomeOnBoard() {

		userName = customerService.getAllCustomers().stream().map(CustomerDTO::getEmail)
				.filter(email -> email.contains("rahul@gmail.com")).findFirst().orElse("No User found");
